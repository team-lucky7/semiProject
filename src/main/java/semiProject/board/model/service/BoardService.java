...
//		}
	 ...
	 * @throws Exception
	 */
	public BoardDetail selectThemaBoardDetail(int boardNo, int boardCode)throws Exception{
		
		Connection conn = getConnection();
		
		BoardDetail detail = dao.selectThemaBoardDetail(conn, boardNo, boardCode);
	...
	public int insertThemaBoard(BoardDetail detail, List<BoardImage> imageList, int boardCode) throws Exception {
		...
		int locationCode = dao.selectLocationCode(conn, detail);
	...
	public int updateThemaBoard(BoardDetail detail, List<BoardImage> imageList, String deleteList)throws Exception{
		...
		locationCode = dao.updateLocationCode(conn, detail);
